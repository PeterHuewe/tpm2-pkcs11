...
- The software provides the minimum required functionality for __Greengrass Device Tester 1.8.0__
...
### Download Repositories
    ...
    git clone https://github.com/PeterHuewe/tpm2-pkcs11
    git clone https://github.com/OpenSC/libp11.git

### Install tpm2-tss
    cd tpm2-tss
    git checkout 1451d4d90774a685bfa29263e4112c06efa16e05
    ./bootstrap
...
### Install tpm2-abrmd
    cd tpm2-abrmd
    git checkout e83f1443bd6f48a5eda1671fe344280bbca49f5a
    ./bootstrap
...
### Install tpm2-tools
    cd tpm2-tools
    git checkout 9a2a61a3a374a1a813357b08705f18ea969e09d5
    ./bootstrap
    ./configure
    make -j4
    sudo make install
...
### Install tpm2-pkcs11
    ...
    cd tpm2-pkcs11/
    git checkout -t origin/greengrass-hsi
    ./bootstrap -I m4
...
#### Generate a Certificate Signing Request
    openssl req -engine pkcs11 -new -key "pkcs11:object=greenkey;type=private;pin-value=123456" -keyform engine -out /tmp/req.csr
    	...
    	"crypto": {
    		...
    		"principals": {
    			"IoTCertificate": {
    				...
    				"privateKeyPath": "pkcs11:model=TPM2%20PKCS%2311;token=greengrass;object=greenkey;type=private;pin-value=123456"
    			},
